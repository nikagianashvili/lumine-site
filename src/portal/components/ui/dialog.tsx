...
// Same AnimatePresence-driven pattern as the admin's dialog.tsx - `open` is
// duplicated from the parent <Dialog open> at each call site since Radix's
// Content doesn't expose it as a prop.
        ...
        {open && (
          <React.Fragment key="dialog">
            ...
            <DialogPrimitive.Content ref={ref} asChild forceMount {...props}>
              ...
              >
                {children}
                <DialogPrimitive.Close className="absolute right-4 top-4 flex size-9 items-center justify-center rounded-full text-muted-foreground transition-colors hover:bg-muted hover:text-foreground">
                  <X className="size-4" />
