...
// Minimal toast layer — the app previously had no way to tell the user a
// mutation failed: optimistic updates reverted silently and blur-saves
// swallowed errors. Deliberately tiny (no dependency): a stack, a timeout,
// two variants.
