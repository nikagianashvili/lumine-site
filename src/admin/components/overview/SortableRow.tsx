...
// Drag handle only appears in edit mode - the rest of the time a widget row
// looks and behaves exactly like a normal part of the page, charts and all
// stay fully interactive.
export function SortableRow({ id, editing, children }: { id: string; editing: boolean; children: ReactNode }) {
    ...
    >
      {editing && (
        <button
          ...
          {...attributes}
          {...listeners}
          aria-label="Drag to reorder this row"
